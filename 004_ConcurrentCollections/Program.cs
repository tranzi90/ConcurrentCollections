...
namespace ConcurrentCollections
{
    internal class Program
    {
        ...
        private static async Task StartTest(Func<Task> test, string testName)
        {
            try
            {
        ...
        private static async Task TestDictionary()
        {
            int itemsCount = 200;
        ...
        private static async Task TestConcurrentDictionary()
        {
